...
Un subconjunto de estos componentes aparece por defecto en el panel Github del [Gestor de dependencias](../Project/components.md#adding-a-github-dependency), incluyendo:
