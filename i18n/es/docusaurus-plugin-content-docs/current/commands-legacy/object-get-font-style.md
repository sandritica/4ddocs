...
<!--REF #_command_.OBJECT Get font style.Summary-->El comando **OBJECT Get font style** devuelve el estilo actual de la fuente utilizada por el objeto de formulario designado por *object*.<!-- END REF--> 
