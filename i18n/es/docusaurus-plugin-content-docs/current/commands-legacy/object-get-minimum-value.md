...
| minValue | Date, Time, Real | &#8592; | Valor mínimo actual del objeto |

<!-- END REF-->

## Descripción 

<!--REF #_command_.OBJECT GET MINIMUM VALUE.Summary-->El comando **OBJECT GET MINIMUM VALUE** devuelve, en la variable *minValue*, el valor mínimo actual del objeto o de los objetos designado(s) por los parámetros *object* y *\**.<!-- END REF-->
