...
| recursive | Boolean | &#8594; | True = contraer los subniveles<br/>False = no contraer los subniveles |
| selector | Integer | &#8594; | Parte del list box a contraer |
| line | Integer | &#8594; | Número de línea de la ruptura a contraer o <br/>Número de nivel del listbox a contraer |
| column | Integer | &#8594; | Número de columna de la ruptura a contraer |

<!-- END REF-->

## Descripción 

<!--REF #_command_.LISTBOX COLLAPSE.Summary-->El comando **LISTBOX COLLAPSE** se utiliza para contraer líneas de ruptura del objeto list box designado por los parámetros *object* y *\** parámetros.<!-- END REF-->
...
El parámetro opcional *recursive* se utiliza para configurar la contracción de los subniveles jerárquicos del list box. Pase True u omita este parámetro para que el comando contraiga todos los niveles y subniveles. Si pasa False, sólo el primer nivel se contraerá. 
