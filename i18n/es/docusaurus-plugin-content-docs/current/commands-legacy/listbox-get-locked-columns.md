...
<!--REF #_command_.LISTBOX Get locked columns.Summary-->El comando **LISTBOX Get locked columns** devuelve el número de columnas bloqueadas en el list box designado por los parámetros *object* y *\**.<!-- END REF-->  
