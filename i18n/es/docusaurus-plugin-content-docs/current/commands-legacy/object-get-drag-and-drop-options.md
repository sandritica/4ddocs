...
| draggable | Boolean | &#8592; | 0 = False, 1 = True |
| automaticDrag | Boolean | &#8592; | 0 = False, 1 = True |
| droppable | Boolean | &#8592; | 0 = False, 1 = True |
| automaticDrop | Boolean | &#8592; | 0 = False, 1 = True |
...
* *draggable* \= True: objeto arrastrable en modo programado.
* *automaticDrag* \= True (utilizable únicamente con los campos y variables texto, combo boxes y list boxes): Objeto arrastrable en modo automático.
* *droppable* \= True: objeto acepta soltar en modo programado.
* *automaticDrop* \= True (utilizable únicamente con los campos y variables imagen, texto, combo boxes y list boxes): Objeto acepta soltar en modo automático.
