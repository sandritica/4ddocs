...
| calculation | Integer | &#8594; | Cálculo para el área de pie |

<!-- END REF-->

## Descripción 

<!--REF #_command_.LISTBOX SET FOOTER CALCULATION.Summary-->El comando **LISTBOX SET FOOTER CALCULATION** permite definir el cálculo automático asociado al área de pie del list box designado por los parámetros *object* y *\**.<!-- END REF-->  
...
El parámetro *object* puede designar:
...
En el parámetro *calculation*, pase una de las siguientes constantes del tema *List box cálculo pie* , con el fin de definir el cálculo a efectuar:  
