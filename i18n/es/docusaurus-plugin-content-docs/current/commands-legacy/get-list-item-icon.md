...
| list | Integer, Text | &#8594; | Número de referencia de lista (si se omite *) o Nombre de objeto de tipo de lista (si pasa *) |
...
| icon | Picture | &#8592; | Icono asociado al elemento |

<!-- END REF-->

## Descripción 

<!--REF #_command_.GET LIST ITEM ICON.Summary-->El comando **GET LIST ITEM ICON** devuelve, en *icon*, el icono asociado al elemento cuyo número de referencia se pasa en *refElem* de la lista cuyo número de referencia o nombre de objeto pasa en *lista*.<!-- END REF-->  
