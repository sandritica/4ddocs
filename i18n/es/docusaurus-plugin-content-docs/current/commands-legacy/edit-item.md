...
| --- | --- | --- | --- |
| * | Operator | &#8594;  | Si se especifica, objeto es un nombre de objeto (cadena) Si se omite, objeto es una tabla o variable |
| object | Text, Table, Variable | &#8594;  | Nombre del objeto (si se especifica *) o Tabla o variable (si se omite *) |
| item | Integer | &#8594;  | Número de elemento |
