...
<!--REF #_command_.OBJECT Get font size.Summary-->El comando **OBJECT Get font size** devuelve el tamaño (en puntos) de la fuente utilizada por el objeto de formulario designado por *object*.<!-- END REF--> 
