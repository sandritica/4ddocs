...
| --- | --- | --- | --- |
| * | Operator | &#8594; | Si se especifica, lista es un nombre de objeto (cadena) Si se omite, lista es un número de referencia de la lista |
...
| value | Text, Boolean, Real | &#8592; | Valor actual del parámetro |
