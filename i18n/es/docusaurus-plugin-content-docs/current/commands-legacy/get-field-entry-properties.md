...
| --- | --- | --- | --- |
| fieldPtr | Pointer | &#8594;  | Puntero del campo |
| tableNum | Integer | &#8594;  | Número de tabla |
| fieldNum | Integer | &#8594; | Número de campo si el número de tabla se pasa como primer parámetro |
| list | Text | &#8592; | Nombre de la lista asociada o cadena vacía |
| mandatory | Boolean | &#8592; | True = Obligatorio, False = Opcional |
| nonEnterable | Boolean | &#8592; | True = No editable, False = Editable |
| nonModifiable | Boolean | &#8592; | True = No modificable, False = Modificable |
